...
function loadEnvFile() {
  ...
  if (fs.existsSync(envPath)) {
    ...
    console.log(
      colorize("✅ Loaded environment variables from .env file", "green"),
    );
    return true;
  } else {
    console.log(
      colorize("⚠️  No .env file found in current directory", "yellow"),
    );
    return false;
  }
}
...
function validateEnvironment() {
  ...
  optionalVars.forEach((varConfig) => {
    ...
    if (error) {
      ...
      const status = value ? "✅" : "🔧";
      console.log(
        colorize(`${status} ${varConfig.name}`, value ? "green" : "yellow"),
      );
...
function checkTemplateFile() {
  ...
  if (fs.existsSync(templatePath)) {
    console.log(colorize("✅ .env.example file found", "green"));
    return true;
  } else {
    console.log(colorize("⚠️  .env.example file not found", "yellow"));
    console.log(
      "💡 This file provides a template for environment variable configuration",
    );
    return false;
  }
}
...
function main() {
  ...
  console.log(
    colorize("This script validates your environment configuration\n", "blue"),
  );
